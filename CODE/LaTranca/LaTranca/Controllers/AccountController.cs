...
namespace LaTranca.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Varible para poder acceder a todos los metodos de la BD de La Tranca
        GeneralAppService appLT = new GeneralAppService();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("InicioLaTranca", "Home");
                }
                AddErrors(result);
            }
        ...
        [AllowAnonymous]
        [HttpGet]
        public ActionResult RegistrarUsuarioLaTranca()
        {
        ...
        [AllowAnonymous]
        [HttpPost]
        public ActionResult RegistrarUsuarioLaTranca(TR_USUARIO model)
        {
